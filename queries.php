...
$exchangesWk1 = mysqli_query($connection,"SELECT COALESCE(COUNT(id),0) AS 'sum' FROM home_exchange_request where DATE(Created_at) >= DATE_SUB( CURDATE(), INTERVAL 1 MONTH ) and DATE(Created_at) < DATE_SUB( CURDATE(), INTERVAL 3 WEEK ) AND request_response = '2'")or die($connection->error);
$exchangesWk2 = mysqli_query($connection,"SELECT COALESCE(COUNT(id),0) AS 'sum' FROM home_exchange_request where DATE(Created_at) >= DATE_SUB( CURDATE(), INTERVAL 3 WEEK ) and DATE(Created_at) < DATE_SUB( CURDATE(), INTERVAL 2 WEEK ) AND request_response = '2'")or die($connection->error);
$exchangesWk3 = mysqli_query($connection,"SELECT COALESCE(COUNT(id),0) AS 'sum' FROM home_exchange_request where DATE(Created_at) >= DATE_SUB( CURDATE(), INTERVAL 2 WEEK ) and DATE(Created_at) < DATE_SUB( CURDATE(), INTERVAL 1 WEEK ) AND request_response = '2'")or die($connection->error);
$exchangesWk4 = mysqli_query($connection,"SELECT COALESCE(COUNT(id),0) AS 'sum' FROM home_exchange_request where DATE(Created_at) >= DATE_SUB( CURDATE(), INTERVAL 1 WEEK ) and DATE(Created_at) <= DATE_SUB( CURDATE(), INTERVAL 0 DAY ) AND request_response = '2'")or die($connection->error);
