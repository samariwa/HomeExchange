...
//redirect the user back to login page for re-authentication
  ...
  header('Location: ../'.$login_url.'?page_url='.$admin_dashboard_link );
  exit;
}
}
else{
...
<head>
 ...
 <link rel = "icon" sizes="196x196" href="../assets/images/home_swap_logo.png" type = "image/x-icon">
        ...
        <a class="nav-link" href="dashboard.php" style="color: black;">
            ...
            <span style="margin-left: 55px">Super User</span></a>
              <?php
               ...
               ?> 
            <span style="margin-left: 55px">Administrator</span></a>
              <?php
               }
               ?>          
      </li>
            ...
            <li class="nav-item dropdown no-arrow mx-1">
             ...
             <li class="nav-item dropdown open" >
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href='<?php echo '../'.$logout_url.'?page_url='.$home_link; ?>'><i class="fa fa-sign-out"></i>&ensp;Logout</a>
              </div>
            </li>
              <?php
                 //}
