...
class HomeAvailabilityDetails{
    ...
    public function UpdateHomeAvailability($availability_id, $start_date, $end_date, $extra_details)
    {
        $query = new Database();
        return $query->update("home_availability", "id", $availability_id, array( 'availability_start_date' => $start_date, 'availability_end_date' => $end_date, 'extra_details' => $extra_details));
    }
