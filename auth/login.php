...
<!--===============================================================================================-->
  ...
  <div class="limiter">
    <div class="container-login100" style="background-image:url('../assets/images/login_bg<?php echo shuffleImage(1,10) ?>.jpeg');background-repeat: no-repeat;background-size: 1300px 800px;">
